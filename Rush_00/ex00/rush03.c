...
/*   Updated: 2023/10/01 22:43:52 by aschenk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
-	Looping through every middle row:
	- Linebreak and prints 'B' (left line)/
	- Looping through every middle column: Prints 'space'.
	- Prints 'B' (right line), if no (more) middle columns.
*/
...
-	Linebreak and prints bottom left corner ('A').
-	Counts down the middle columns (lines) and fills
	this row with 'B'.
-	When the middle column counter reaches zero,
	displays the bottom right corner ('C').
*/
