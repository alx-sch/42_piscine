...
/*   Updated: 2023/10/01 22:42:33 by aschenk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
-	Displays the top left corner by default ('o').
-	Counts down the middle columns (horizontal lines) and fills
	this row with '-'.
-	When the middle column counter reaches zero,
	displays the top right corner ('o').
*/
...
-	Looping through every middle row:
	- Linebreak and prints '|' (vertical left line)/
	- Looping through every middle column: Prints 'space'.
	- Prints '|' (vertical right line), if no (more) middle columns.
*/
...
-	Linebreak and prints bottom left corner ('o').
-	Counts down the middle columns (horizontal lines) and fills
	this row with '-'.
-	When the middle column counter reaches zero,
	displays the bottom right corner ('o').
*/
